...
```bash
sam delete --stack-name basic-aws-apigateway-demo
```
...
Next, you can use the AWS Serverless Application Repository to deploy ready-to-use apps that go beyond Hello World samples and learn how authors developed their applications. For more information, see the [AWS Serverless Application Repository main page](https://aws.amazon.com/serverless/serverlessrepo/) and the [AWS Serverless Application Repository Developer Guide](https://docs.aws.amazon.com/serverlessrepo/latest/devguide/what-is-serverlessrepo.html).
       ...
       Creating the required resources...
        ...
        Uploading to 0872bb25d23d85d47fcfc7901a5c37cc  70780552 / 70780552  (100.00%)
File with same data already exists at 0872bb25d23d85d47fcfc7901a5c37cc, skipping upload
File with same data already exists at 0872bb25d23d85d47fcfc7901a5c37cc, skipping upload

        Deploying with following values
        ===============================
        Stack name                   : basic-aws-apigateway-demo
...
=====================
        ...
        Uploading to e6c0b649acde33b9f44b6492e0fefce9.template  3775 / 3775  (100.00%)
...
-------------------------------------------------------------------------------------------------------------------------------------------------      
+ Add                                ApplicationInsightsMonitoring        AWS::ApplicationInsights::Applicat   N/A
                                                                          ion
+ Add                                ApplicationResourceGroup             AWS::ResourceGroups::Group           N/A
+ Add                                SampleTable                          AWS::DynamoDB::Table                 N/A
+ Add                                ServerlessRestApiDeploymenta4d359a   AWS::ApiGateway::Deployment          N/A
                                     69a
+ Add                                ServerlessRestApiProdStage           AWS::ApiGateway::Stage               N/A
+ Add                                ServerlessRestApi                    AWS::ApiGateway::RestApi             N/A
+ Add                                getAllItemsFunctionApiPermissionPr   AWS::Lambda::Permission              N/A
                                     od
...
Changeset created successfully. arn:aws:cloudformation:ap-southeast-1:604020082473:changeSet/samcli-deploy1702475878/aded7fe0-8c61-43f8-acbd-1bc4fed06419


Previewing CloudFormation changeset before deployment
======================================================
Deploy this changeset? [y/N]:
PS C:\Users\joelw\Desktop\Office\production\prodxcloud\prodxcloud-operations\serverless\sam\basic-aws-apigateway-demo>
PS C:\Users\joelw\Desktop\Office\production\prodxcloud\prodxcloud-operations\serverless\sam\basic-aws-apigateway-demo>